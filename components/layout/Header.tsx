...
export function Header() {
  ...
  return (
    <header className="bg-white backdrop-blur-lg bg-opacity-90 shadow-sm border-b border-gray-200/50 sticky top-0 z-50">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900 leading-none">GEDPro-RH</h1>
                <p className="text-xs text-gray-500 hidden sm:block">Gestion Électronique des Documents</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="relative p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-all duration-200">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5l-5-5h5V3h0z" />
              </svg>
            ...
            <div className="relative">
              <button 
                ...
                className="flex items-center space-x-3 text-sm bg-gray-50 hover:bg-gray-100 rounded-xl px-3 py-2 transition-all duration-200 border border-transparent hover:border-gray-200"
              >
